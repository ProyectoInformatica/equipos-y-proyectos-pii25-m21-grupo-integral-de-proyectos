...
class DataController:
    ...
    # SENSOR BIORDINARIO
    @staticmethod
    def obtener_datos_biordinario(limit: int = 24):
        """Devuelve las últimas lecturas del sensor biordinario (valor numérico + texto)."""
        return get_biordinario_data(limit)
